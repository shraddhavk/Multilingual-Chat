...
import { getUsersByConversationId, MembershipHash } from '../conversationMemberModel';
import { getPresenceByConversationId, ConversationPresence } from 'features/memberPresence/memberPresenceModel';
...
export const getCurrentConversationMembers = createSelector(
    [getUsersById, getCurrentConversationId, getUsersByConversationId, getPresenceByConversationId],
    (
