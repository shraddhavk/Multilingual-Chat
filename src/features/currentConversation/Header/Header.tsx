...
import { ConversationsIndexedById, getConversationsById } from 'features/conversations/conversationModel';
import { getCurrentConversationId } from '../currentConversationModel';
import { Wrapper, Body, Information, Name, Description, Border, BackIconWrapper } from './Header.style';
...
export const getCurrentConversationDescription = createSelector(
    ...
    (conversations: ConversationsIndexedById, currentConversationId: string): ConversationDescriptionFragment => {
        return {
...
const Header = () => {
    const conversation: ConversationDescriptionFragment = useSelector(getCurrentConversationDescription);
